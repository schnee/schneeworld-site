...
my_experience <- tibble::tribble(
  ...
  "Vice President, Data Science and Analytics", "June 2020", "August 2022", "Overhaul, Inc", "First hire with data-specific focus, built Data organizaion with Data Engineering, Data Analytics, Data Science and Machine Learning focus. Guided by collaboration, built team to deliver internal and external data-as-a-product features (e.g. reports, data assets, ML models). Provided direction and product strategy for machine learning and data transformation pipelines, and for a robust data warehouse strategy.",
  "Vice President, Data Science and Analytics", "June 2020", "August 2022", "Overhaul, Inc", "Six-month expat assignment in 2022 to build Data Science and Engineering team in Ireland. Partnered with local recruiters. Also partnered with local groups and universities to build recruitment pipeline.",
