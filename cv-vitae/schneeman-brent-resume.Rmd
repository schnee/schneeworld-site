...
my_experience <- tibble::tribble(
  ...
  # PMG
  "Director, AI", "March 2024", "current", "PMG", "Leading AI and machine learning efforts at PMG, specifically in intersecting the content of advertisements and KPI performance. Evolving customer-facing technology from descriptive analytics to predictive, leveraging GenAI and classic machine learning.",
  # Thought and Memory
