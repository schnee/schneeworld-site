...
I have broad leadership experience across data scientists, software engineers, data analysts, and data engineers, having scaled-from-zero durable teams across disciplines and companies. My software engineering and leadership skills greatly facilitated a re-focus on data science and machine learning as writing code enabled rapid learning and hypothesis testing. I am adept at combining engineering and science to help companies unlock the value of their data as they pivot to modern algorithmic-based business models. I have overseen and architected data data solutions to provide APIs and platforms which expose ML and AI to stakeholders.
...
my_expertise <- tibble::tribble(
  ...
  "Skills", "Operationalizing algorithms, team building and leading, strategic thinking"
)
...
my_experience <- tibble::tribble(
  ...
  "Senior Director, Machine Learning", "March 2019", "", "Alegion, Inc", "Delivered AWS Sagemaker and \"Faster R-CNN\"-based solution for image classification and object detection for customer-specific use cases. ML improved throughput by 30% over the fully-manual process, and used AWS Lambda functions and SQS messaging", 
