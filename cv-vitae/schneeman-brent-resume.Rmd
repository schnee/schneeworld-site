...
my_expertise <- tibble::tribble(
  ...
  "Collaboration", "Strategic thinking, Engineering and Science leadership, C-Level advisor, Team design, Culture change",
  "Miscellaneous", "Operationalizing algorithms, Product orientation, Curricula design"
)
...
my_volunteer <- tibble::tribble(
  ...
  "Industry Adviser", "May 2015", "", "UT McCombs School of Business, Masters of Science, Business Analytics", "Advising McCombs on Industry needs for Data Science related curricula. Directly hired three graduates and influential in hiring 4 others"
)
